...
export_fig localization_error_cartesian -pdf 
...
%     char('2� Backward (Cartesian) CaffeNet \sigma = 1 ');...
%     char('2� Backward (Cartesian) CaffeNet \sigma = 5 ');...
%     char('2� Backward (Cartesian) VGGNet \sigma = 1 ');...
%     char('2� Backward (Cartesian) VGGNet \sigma = 5 ');...
%     char('2� Backward (Cartesian) GoogLeNet \sigma = 1 ');...
%     char('2� Backward (Cartesian) GoogLeNet \sigma = 5 ');...
%     };
...
%     char('top-1 2� feed-foward (Cartesian) CaffeNet ');...
%     char('top-5 2� feed-foward (Cartesian) CaffeNet ');...
%     char('top-1 2� feed-foward (Cartesian) VGGNet ');...
%     char('top-5 2� feed-foward (Cartesian) VGGNet ');...
%     char('top-1 2� feed-foward (Cartesian) GoogLeNet ');...
%     char('top-5 2� feed-foward (Cartesian) GoogLeNet ');...
%     };
