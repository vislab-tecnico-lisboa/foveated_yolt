...
cv::Mat foveate(const cv::Mat & img, int & size_map)
{
    // Foveate images
...
//    string ground_class;
>>>>>>> 2691ca9006c163676270b4d60fba02841c2cf983
...
<<<<<<< HEAD
    // store results
    feedforward_detection.open ("raw_bbox_parse.txt",ios::app);          // file with 5 classes + scores + 5 bounding boxes
