...
% Para o vale - threshold - muitos parametros
%detections_vale = '../dataset/detections/new/raw_bbox_muitos_parametros_caffenet_100.txt';
%feedback_detection_vale='../dataset/detections/new/feedback_detection_muitos_parametros_caffenet_100.txt';
...
% get detections (YOLO) - Vale
% [vale_sigmas,vale_threshs,vale_classes,vale_scores,vale_detections]=parse_detections2(...
%     images_number,...
%     detections_vale);
...
% CAFFE
% get feedback detections (Vale) 
% [vale_feedback_sigmas,vale_feedback_threshs,vale_feedback_classes,vale_feedback_scores]=feedback_parse_detections(...
%     images_number,...
%     feedback_detection_vale);
...
% get classification error rates (YOLO) - Caffe - Vale
% [top1_vale_classification_error_rate, top5_vale_classification_error_rate] = classification_error_rates(vale_feedback_sigmas,vale_feedback_threshs,images_number,vale_feedback_classes,gt_classes,top_k);
...
classification_legend = {...
    char('top-1 feed-foward ');...
    char('top-5 feed-foward ');...
    char('top-1 feed-foward (fovea) ');...
    char('top-5 feed-foward (fovea) ');... 
    char('top-1 feed-foward (crop) ');...
    char('top-5 feed-foward (crop) ');...
    };
...
% plot(threshs,100*top1_vale_classification_error_rate(:,:));
% hold on
% plot(threshs,100*top5_vale_classification_error_rate(:,:));
% xlabel('$th$','Interpreter','LaTex','FontSize',fontsize);
% ylabel('Localization Error (%)','Interpreter','LaTex','FontSize',fontsize);
% %xlim([20 100])
% ylim([0 100])
% legend('show', 'DislpayName', classification_legend_vale(:) ,'Location', 'bestoutside');
% %saveas(figure(4),'localization_error_threshold_crop_caffenet_5000.pdf')
