function [tp1_class_error_av,tp1_class_error_std,tp5_class_error_av,tp5_class_error_std,class_error_1pos,class_error_5pos] = classification_error_rates(sigmas,threshs,fix_pts, images_number,classes,gt_classes, top_k)
...
class_error_5pos=((size(top5_classification,4))*(size(top5_classification,2))*(size(top5_classification,1))-...
    sum(sum(sum(top5_classification,4),2),1))/((size(top5_classification,4))*(size(top5_classification,2))*(size(top5_classification,1)));
class_error_1pos=((size(top1_classification,4))*(size(top1_classification,2))*(size(top1_classification,1))-...
