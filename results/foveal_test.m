...
localization_legend = {...
    char('Backward (Foveal) CaffeNet');...
    char('Backward (Foveal) VGGNet');...
    char('Backward (Foveal) GoogLeNet');...
    };
...
classification_legend = {...
    char('feed-foward (Foveal) CaffeNet ');...
    char('feed-foward (Foveal) VGGNet');...
    char('feed-foward (Foveal) GoogLeNet');...
    };
...
feedback_localization_legend = {...
    char('2º Backward (Foveal) CaffeNet');...
    char('2º Backward (Foveal) VGGNet');...
    char('2º Backward (Foveal) GoogLeNet');...
    };
...
feedback_classification_legend = {...
    char('2º feed-foward (Foveal) CaffeNet ');...
    char('2º feed-foward (Foveal) VGGNet');...
    char('2º feed-foward (Foveal) GoogLeNet');...
    };
