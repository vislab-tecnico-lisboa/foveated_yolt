...
// version from https://github.com/edmBernard/pybind11_opencv_numpy
// MIT License
...
public:
    ...
    UMatData* allocate(int dims0, const int* sizes, int type, void* data, size_t* step, cv::AccessFlag flags, cv::UMatUsageFlags usageFlags) const //int flags, UMatUsageFlags usageFlags) const
    {
        if( data != 0 )
        {
