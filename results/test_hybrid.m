...
%% DETECTIONS - Second passage - Imagem com alta resoluчуo que щ foveada no centro da bbox (varios sigmas)
...
feedback_localization_legend = {...
    char('2К Backward (Foveal) CaffeNet \sigma = 80');...
    char('2К Backward (Foveal) CaffeNet \sigma = 100');...
    char('2К Backward (Foveal) VGGNet \sigma = 80');...
    char('2К Backward (Foveal) VGGNet \sigma = 100');...
    char('2К Backward (Foveal) GoogLeNet \sigma = 80');...
    char('2К Backward (Foveal) GoogLeNet \sigma = 100');...
    };
...
feedback_classification_legend = {...
    char('top-1 2К feed-foward (Foveal) CaffeNet ');...
    char('top-5 2К feed-foward (Foveal) CaffeNet ');...
    char('top-1 2К feed-foward (Foveal) VGGNet');...
    char('top-5 2К feed-foward (Foveal) VGGNet');...
    char('top-1 2К feed-foward (Foveal) GoogLeNet');...
    char('top-5 2К feed-foward (Foveal) GoogLeNet');...
    };
