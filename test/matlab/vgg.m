...
set(gca,'YTick',[0:20:100], 'FontSize', fontsize);
legend('show', 'DislpayName', localization_legend(:) ,'Location', 'southwest');
saveas(figure(5), 'localization_error_vgg_all_models_1vs2.png');
%export_fig localization_error_vgg_all_models_1vs2 -pdf
...
set(gca, 'XTick',[0:10:100], 'YTick',[0:20:100], 'FontSize', fontsize);
legend(classification_legend(:),'Location', 'southwest');  % southeast
saveas(figure(6),'classification_error_vgg_feedback_1vs2_top1.png')
%export_fig classification_error_vgg_feedback_1vs2_top1 -pdf
...
set(gca, 'XTick',[0:10:100], 'YTick',[0:20:100], 'FontSize', fontsize);
legend(classification_legend(:),'Location', 'southwest');  % southeast
saveas(figure(7),'classification_error_vgg_feedback_1vs2_top5.png')
%export_fig classification_error_vgg_feedback_1vs2_top5 -pdf
